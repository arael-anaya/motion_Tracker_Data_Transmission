...
#include "mocap4r2_msgs/msg/detail/markers__rosidl_typesupport_fastrtps_c.h"
...
using _Markers__ros_msg_type = mocap4r2_msgs__msg__Markers;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mocap4r2_msgs__msg__Markers;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mocap4r2_msgs__msg__Markers * ros_message = static_cast<const mocap4r2_msgs__msg__Markers *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mocap4r2_msgs__msg__Markers(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mocap4r2_msgs__msg__Markers * ros_message = static_cast<mocap4r2_msgs__msg__Markers *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mocap4r2_msgs__msg__Markers(cdr, ros_message);
}

static uint32_t _Markers__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mocap4r2_msgs__msg__Markers(
...
static size_t _Markers__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mocap4r2_msgs__msg__Markers(
