...
#include "mocap4r2_msgs/msg/detail/imus_info__rosidl_typesupport_fastrtps_c.h"
...
using _ImusInfo__ros_msg_type = mocap4r2_msgs__msg__ImusInfo;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mocap4r2_msgs
bool cdr_serialize_mocap4r2_msgs__msg__ImusInfo(
  const mocap4r2_msgs__msg__ImusInfo * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mocap4r2_msgs
bool cdr_deserialize_mocap4r2_msgs__msg__ImusInfo(
  eprosima::fastcdr::Cdr & cdr,
  mocap4r2_msgs__msg__ImusInfo * ros_message)
{
  // Field name: sensor_ids
  {
    uint32_t cdrSize;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mocap4r2_msgs
size_t get_serialized_size_mocap4r2_msgs__msg__ImusInfo(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mocap4r2_msgs
size_t max_serialized_size_mocap4r2_msgs__msg__ImusInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mocap4r2_msgs__msg__ImusInfo;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mocap4r2_msgs
bool cdr_serialize_key_mocap4r2_msgs__msg__ImusInfo(
  const mocap4r2_msgs__msg__ImusInfo * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: sensor_ids
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mocap4r2_msgs
size_t get_serialized_size_key_mocap4r2_msgs__msg__ImusInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ImusInfo__ros_msg_type * ros_message = static_cast<const _ImusInfo__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mocap4r2_msgs
size_t max_serialized_size_key_mocap4r2_msgs__msg__ImusInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mocap4r2_msgs__msg__ImusInfo * ros_message = static_cast<const mocap4r2_msgs__msg__ImusInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mocap4r2_msgs__msg__ImusInfo(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mocap4r2_msgs__msg__ImusInfo * ros_message = static_cast<mocap4r2_msgs__msg__ImusInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mocap4r2_msgs__msg__ImusInfo(cdr, ros_message);
}

static uint32_t _ImusInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mocap4r2_msgs__msg__ImusInfo(
...
static size_t _ImusInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mocap4r2_msgs__msg__ImusInfo(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mocap4r2_msgs, msg, ImusInfo)() {
