...
#include "mocap4r2_msgs/msg/detail/rigid_bodies__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const mocap4r2_msgs::msg::RigidBody &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  mocap4r2_msgs::msg::RigidBody &);
size_t get_serialized_size(
  const mocap4r2_msgs::msg::RigidBody &,
  size_t current_alignment);
size_t
  ...
  size_t current_alignment)
{
  ...
  // Member: rigidbodies
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mocap4r2_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RigidBody(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mocap4r2_msgs::msg::RigidBodies;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mocap4r2_msgs
max_serialized_size_key_RigidBodies(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: rigidbodies
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mocap4r2_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_RigidBody(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mocap4r2_msgs::msg::RigidBodies *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mocap4r2_msgs::msg::RigidBodies *>(
    untyped_ros_message);
...
get_message_type_support_handle<mocap4r2_msgs::msg::RigidBodies>()
{
  return &mocap4r2_msgs::msg::typesupport_fastrtps_cpp::_RigidBodies__handle;
}
