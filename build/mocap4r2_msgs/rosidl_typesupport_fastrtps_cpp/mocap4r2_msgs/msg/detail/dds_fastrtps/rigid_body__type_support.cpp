...
#include "mocap4r2_msgs/msg/detail/rigid_body__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const mocap4r2_msgs::msg::Marker &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  mocap4r2_msgs::msg::Marker &);
...
cdr_serialize(
  const mocap4r2_msgs::msg::RigidBody & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: markers
  {
    ...
    for (size_t i = 0; i < size; i++) {
      mocap4r2_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mocap4r2_msgs::msg::RigidBody & ros_message)
{
  // Member: rigid_body_name
  cdr >> ros_message.rigid_body_name;
  ...
  // Member: markers
  {
    ...
    for (size_t i = 0; i < size; i++) {
      mocap4r2_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        mocap4r2_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mocap4r2_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Marker(
  ...
  if (is_plain) {
    ...
    using DataType = mocap4r2_msgs::msg::RigidBody;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: markers
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      mocap4r2_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.markers[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        mocap4r2_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.markers[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mocap4r2_msgs
max_serialized_size_key_RigidBody(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mocap4r2_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Marker(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mocap4r2_msgs::msg::RigidBody *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mocap4r2_msgs::msg::RigidBody *>(
    untyped_ros_message);
...
{
  return &mocap4r2_msgs::msg::typesupport_fastrtps_cpp::_RigidBody__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mocap4r2_msgs, msg, RigidBody)() {
  return &mocap4r2_msgs::msg::typesupport_fastrtps_cpp::_RigidBody__handle;
}
