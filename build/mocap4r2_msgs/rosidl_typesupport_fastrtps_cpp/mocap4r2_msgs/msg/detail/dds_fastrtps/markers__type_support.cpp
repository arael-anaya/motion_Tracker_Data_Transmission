...
#include "mocap4r2_msgs/msg/detail/markers__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mocap4r2_msgs::msg::Markers & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mocap4r2_msgs::msg::Markers & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mocap4r2_msgs::msg::Markers;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mocap4r2_msgs
max_serialized_size_key_Markers(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const mocap4r2_msgs::msg::Markers *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mocap4r2_msgs::msg::Markers *>(
    untyped_ros_message);
...
{
  return &mocap4r2_msgs::msg::typesupport_fastrtps_cpp::_Markers__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mocap4r2_msgs, msg, Markers)() {
  return &mocap4r2_msgs::msg::typesupport_fastrtps_cpp::_Markers__handle;
}
