...
#include "mocap4r2_msgs/msg/detail/marker__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mocap4r2_msgs::msg::Marker & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mocap4r2_msgs::msg::Marker & ros_message)
{
  // Member: id_type
  cdr >> ros_message.id_type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mocap4r2_msgs::msg::Marker;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mocap4r2_msgs::msg::Marker *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mocap4r2_msgs::msg::Marker *>(
    untyped_ros_message);
...
{
  return &mocap4r2_msgs::msg::typesupport_fastrtps_cpp::_Marker__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mocap4r2_msgs, msg, Marker)() {
  return &mocap4r2_msgs::msg::typesupport_fastrtps_cpp::_Marker__handle;
}
