...
bool cdr_serialize_mocap4r2_control_msgs__msg__MocapInfo(
  const mocap4r2_control_msgs__msg__MocapInfo * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mocap4r2_control_msgs
bool cdr_deserialize_mocap4r2_control_msgs__msg__MocapInfo(
  eprosima::fastcdr::Cdr & cdr,
  mocap4r2_control_msgs__msg__MocapInfo * ros_message)
{
  // Field name: mocap4r2_source
  {
    std::string tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mocap4r2_control_msgs
bool cdr_serialize_key_mocap4r2_control_msgs__msg__MocapInfo(
  const mocap4r2_control_msgs__msg__MocapInfo * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: mocap4r2_source
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mocap4r2_control_msgs
size_t get_serialized_size_key_mocap4r2_control_msgs__msg__MocapInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MocapInfo__ros_msg_type * ros_message = static_cast<const _MocapInfo__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mocap4r2_control_msgs
size_t max_serialized_size_key_mocap4r2_control_msgs__msg__MocapInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mocap4r2_control_msgs__msg__MocapInfo * ros_message = static_cast<const mocap4r2_control_msgs__msg__MocapInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mocap4r2_control_msgs__msg__MocapInfo(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mocap4r2_control_msgs__msg__MocapInfo * ros_message = static_cast<mocap4r2_control_msgs__msg__MocapInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mocap4r2_control_msgs__msg__MocapInfo(cdr, ros_message);
}
