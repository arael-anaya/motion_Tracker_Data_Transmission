...
bool cdr_serialize_mocap4r2_control_msgs__msg__Control(
  const mocap4r2_control_msgs__msg__Control * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mocap4r2_control_msgs
bool cdr_deserialize_mocap4r2_control_msgs__msg__Control(
  eprosima::fastcdr::Cdr & cdr,
  mocap4r2_control_msgs__msg__Control * ros_message)
{
  // Field name: control_type
  {
    cdr >> ros_message->control_type;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mocap4r2_control_msgs
bool cdr_serialize_key_mocap4r2_control_msgs__msg__Control(
  const mocap4r2_control_msgs__msg__Control * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: control_type
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mocap4r2_control_msgs
size_t get_serialized_size_key_mocap4r2_control_msgs__msg__Control(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Control__ros_msg_type * ros_message = static_cast<const _Control__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mocap4r2_control_msgs
size_t max_serialized_size_key_mocap4r2_control_msgs__msg__Control(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mocap4r2_control_msgs__msg__Control * ros_message = static_cast<const mocap4r2_control_msgs__msg__Control *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mocap4r2_control_msgs__msg__Control(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mocap4r2_control_msgs__msg__Control * ros_message = static_cast<mocap4r2_control_msgs__msg__Control *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mocap4r2_control_msgs__msg__Control(cdr, ros_message);
}
